                    ...
                    layout = {
                        layout = {
                            ...
                            width = 40,
                            {
                                ...
                                wo = {
                                    winhighlight =
                                    "FloatBorder:SnacksExplorerBorder,NormalFloat:SnacksExplorerNormal,SnacksPickerPrompt:SnacksPickerPromptTransparent,Title:SnacksPickerInputTitle",
                                },
                            },
                            {
                                win = "list",
            ...
            preset = {
                keys = {
                    ...
                    },
                    {
                        ...
                        key = "c",
                        action =
                        ":lua vim.cmd('cd ~/dotfiles/.config/nvim') vim.cmd('edit ~/dotfiles/.config/nvim/init.lua')",
                    },
                    {
                        text = {
                            { "", hl = "SnacksDashboardText", width = 2 },
